...
\copy concept FROM 'data/vocabulary3/concept.csv' DELIMITER ',' CSV HEADER;
\copy concept_ancestor FROM 'data/vocabulary3/concept_ancestor.csv' DELIMITER ',' CSV HEADER;
\copy concept_relationship FROM 'data/vocabulary3/concept_relationship.csv' DELIMITER ',' CSV HEADER;
